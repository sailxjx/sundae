...
(function() {
  ...
  Router = (function() {
    ...
    Router.prototype.callback = function(err, result) {
      return this.res.response(err, result);
    };
    ...
    Router.prototype._apply = function(options) {
      ...
      return this.app[method](path, function(req, res, next) {
        ...
        return backbone(req, res, function(err, result) {
          this.req = req;
          this.res = res;
          return callback.call(this, err, result, next);
        });
      });
    };
