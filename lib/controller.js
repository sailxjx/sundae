...
(function() {
  ...
  _normalizeOptions = function(options) {
    ...
    if (toString.call(options.transfer) !== '[object Function]') {
  ...
  _insertCallbacks = function(fn, props) {
    var except, only, options, parallel, transfer, _applyCallback, _fn, _ref;
    if (props == null) {
      props = [];
    }
    ...
    _ref = _normalizeOptions(options), only = _ref.only, except = _ref.except, parallel = _ref.parallel, transfer = _ref.transfer;
    ...
    _applyCallback = function() {
      ...
      if ((!_.isEmpty(only) && __indexOf.call(only, action) < 0) || (!_.isEmpty(except) && __indexOf.call(except, action) >= 0)) {
        ...
        if (args[2] && (transfer != null)) {
          args[2] = typeof transfer === "function" ? transfer(args[2]) : void 0;
        }
        if (parallel) {
          _fn.apply(this, args);
          return next(null, args[2] || {});
