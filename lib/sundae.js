...
(function() {
  ...
  Sundae = (function() {
    ...
    Sundae.prototype._config = function(key, fn) {
      var e, loader, _key;
      loader = this[key];
      _key = (loader != null ? loader.key : void 0) || key;
      try {
        fn || (fn = require(path.join(this.get('mainPath'), 'config', _key)));
      } catch (_error) {
        e = _error;
      }
      ...
      return (loader != null ? typeof loader.config === "function" ? loader.config(this.app, fn) : void 0 : void 0) || fn(this.app);
    };

    Sundae.prototype.init = function() {
    ...
    Sundae.prototype.listen = function(callback) {
      if (callback == null) {
        callback = function() {};
      }
      if (!this.app) {
      ...
      return this.app.listen(this._params['port'] || this.app.get('port') || 7000, callback);
    };
    ...
    Sundae.prototype.run = function(callback) {
      ...
      return this.init().listen(callback);
    };
