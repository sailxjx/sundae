...
(function() {
  ...
  Router = (function() {
    ...
    Router.prototype._render = function(data) {
      var result, status, template;
      status = data.status, template = data.template, result = data.result;
    ...
    Router.prototype._applyCtrl = function(rest, callback) {
      ...
      fn = fn || 'index';
      try {
        $ctrl = require("" + this.appRoot + "/controllers")["" + ctrl + "Controller"];
    ...
    Router.prototype.http404 = function(handle) {
      ...
      return this.app.use(this._http404);
    };
    ...
    Router.prototype.http500 = function(handle) {
      ...
      return this.app.use(this._http500);
    };
