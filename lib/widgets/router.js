...
(function() {
  ...
  Router = (function() {
    ...
    Router.prototype._render = function(data) {
      var err, req, res, resType, template, _ref;
      err = data.err, req = data.req, res = data.res, template = data.template;
    ...
    Router.prototype._applyCtrl = function(rest, callback) {
      ...
      return this.app[method](route, function(req, res) {
        var $bundle;
        $bundle = bundle('rest');
        $bundle.set('req', req).set('res', res).set('func', func).set('ctrl', ctrl);
