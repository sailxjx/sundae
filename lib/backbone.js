...
(function() {
  ...
  backbone = function(req, res, callback) {
    var $ctrl, action, middlewares, sundae;
    ...
    return async.waterfall([
      function(next) {
        ...
        return async.eachSeries(sundae._middlewares, function(fn, next) {
          var key;
          if (!fn.before) {
            return next();
          }
        ...
        return async.reduce(sundae._middlewares, result, function(result, fn, next) {
          var key;
          if (!fn.after) {
